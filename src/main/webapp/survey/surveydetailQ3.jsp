                                ...
                                <ul class="question-answer-wrap">
                                    <li>
                                        <label class="label-radio label-question">		
                                            ...
                                            <span></span>눈이 건조하여 뻑뻑하고 가려움을 느껴요.
                                        </label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>눈 주변이 떨리는 현상이 있어요.
                                        </label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>핸드폰이나 컴퓨터를 본 후에 시야가 흐릿하게 느껴져요.
                                        </label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>어두워지면 시력이 저하돼요.
                                        </label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>선택할 것이 없지만 눈건강이 걱정돼요.
                                        </label>
                                    </li>
                                </ul>
