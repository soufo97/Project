	                        ...
	                        <div class="survey-question-contents">
	                            ...
	                            <section class="question-section">
	                                ...
	                                <h2 class="qTitle" maxallowed="1">
	                                    ...
	                                    <p> ${answerMap['surveyQ1'] }님의 성별을 알려주세요.</p>
	                                    <span class=""></span>
	                                </h2>
	                                <p id="qContent"></p>
	                                <ul class="question-answer-wrap">
	                                    <li>
	                                        <label class="label-radio label-question">		
	                                            <input type="radio" class="input-radio input-answer" name="answer" value="2" data-only="null">		
	                                            <span></span>여성</label>
	                                    </li>
	                                    <li>	
	                                        <label class="label-radio label-question">		
...
<script src="/assets/js/surveyvalidation/surveyQ2.js"></script>
</html>