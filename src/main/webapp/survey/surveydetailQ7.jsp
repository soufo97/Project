                                ...
                                <ul class="question-answer-wrap">
                                    <li>
                                        <label class="label-radio label-question">		
                                            ...
                                            <span></span>탈모가 진행되고 있거나 탈모가 걱정돼요.
                                        </label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>머리카락이 갈라지고 끊어지는 등 모발 상태가 나빠요.
                                        </label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>같은 또래보다 새치가 많이 나요.
                                        </label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>선택할 것이 없지만 모발 건강이 걱정돼요.
                                        </label>
                                    </li>
                                </ul>
