                ...
                <div class="survey-contents-inner">
                    ...
                    <div class="survey-test">
                                ...
                                <ul class="question-answer-wrap">
                                    <li>
                                        <div class="question-input-field">
                                             <input id="answer" name="answer" type="text" class="input-text input-small input-full" placeholder="이메일" maxlength="40" required="true">
                                        </div>                                       
                                    </li>
                                </ul>
                        ...
                        <div class="survey-question-footer">
                            ...
                            <a href="javascript:dis()"><button id="btn-next" class="btn btn-radius btn-dark">보내기</button></a>
                        </div>
                    </div>
                </div> 
            </div>                 
...
<script src="/assets/js/surveyvalidation/surveyQ13.js"></script>
</html>