                ...
                <div class="survey-contents-inner">
                    ...
                    <div class="survey-test">
                        ...
                        <div class="survey-question-contents">
                            ...
                            <section class="question-section">
                                ...
                                <h2 class="qTitle" maxallowed="1">
                                    <p>${answerMap['surveyQ1'] }님의 몸무게를 적어주세요.</p>
                                    <span></span>
                                </h2>
                                <p id="qContent"></p>
                                <ul class="question-answer-wrap">
                                    <li>
                                        <div class="question-input-field">
                                             <input name="answer"  id="answer" type="text" class="input-text input-small input-full" placeholder="몸무게" maxlength="10" required="true">
                                        </div>
                                          <br>
                                        <div id="dis1" style="display:none;" class="question-input-val">
                                              <span>※답변을 입력해주세요.</span>
                                        </div> 
                                        <div id="dis2"  class="question-input-val" style="display:none;">
                                              <span>※숫자만 입력해주세요.</span>
                                        </div>
                                        <div id="dis3"  class="question-input-val" style="display:none;">
                                              <span>※30부터 190까지만 입력해주세요.</span>
                                        </div>                                                              
                                    </li>
                                </ul>
                            </section>
                        ...
                        <div class="survey-question-footer">
                            ...
                            <a href="javascript:dis()"><button id="btn-next" class="btn btn-radius btn-dark" onblur="dis();" onkeydown="dis();" onpropertychange="dis();" onchange="dis();" onkeyup="dis();" onpaste="dis();" oninput="dis();">다음</button></a>
                        </div>
                    </div>
                </div> 
            </div>                 
...
<script src="/assets/js/surveyvalidation/surveyQ6.js"></script>
</html>