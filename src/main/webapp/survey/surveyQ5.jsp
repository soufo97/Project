                        ...
                        <div class="survey-question-contents">
                            ...
                            <section class="question-section">
                                ...
                                <h2 class="qTitle" maxallowed="1">
                                    <p>${answerMap['surveyQ1'] }님의 키를 적어주세요.</p>
                                    <span></span>
                                </h2>
                                <p id="qContent"></p>
                                <ul class="question-answer-wrap">
                                    <li>
                                        <div class="question-input-field">
                                             <input name="answer" id="answer" type="text" class="input-text input-small input-full" placeholder="키" maxlength="10" required="true">
                                        </div>
                                           <br>
...
<script src="/assets/js/surveyvalidation/surveyQ5.js"></script>
</html>