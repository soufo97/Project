                    ...
                    <div class="survey-test">
                        ...
                        <div class="survey-question-contents">
                            ...
                            <section class="question-section">
                                <em id="qNum">질문 <%=surveyNum %> | 소화/장</em>
                                ...
                                <ul class="question-answer-wrap">
                                    <li>
                                        <label class="label-radio label-question">		
                                            ...
                                            <span></span>복통이나 속 쓰림이 자주 발생해요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>변비가 있어요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>설사와 같은 묽은 변을 자주 보는 편이에요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>술을 마실 때 얼굴이나 몸이 붉어지고 소화가 안돼요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>배뇨 후 소변이 남아있는 느낌(잔뇨감)이 있어요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="answer" value="285" data-only="null">	
                                    	    <span></span>선택할 것이 없지만 소화력 개선이 필요해요.</label>
                                    </li>
                                </ul>
