                        ...
                        <div class="survey-question-contents">
                            ...
                            <section class="question-section">
                                ...
                                <h2 class="qTitle" maxallowed="1">
                                    <p>${answerMap['surveyQ1'] }님의 기호식품 섭취 습관을 모두 선택하세요.</p>
                                    <span class=""></span>
                                </h2>
                                <p id="qContent"></p>
                                <ul class="question-answer-wrap">
                                    <li>
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="bad" value="1" data-only="null">		
                                            <span></span>하루에 담배를 반 갑 이상 피워요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="bad" value="2" data-only="null">	
                                    	    <span></span>하루에 커피를 3잔 이상 마셔요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="bad" value="3" data-only="null">	
                                    	    <span></span>하루에 물을 맥주잔으로 4잔도 안 마셔요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
                                            <input type="checkbox" class="input-radio input-answer" name="bad" value="4" data-only="null">	
                                    	    <span></span>일주일에 인스턴트 음식(라면, 편의점 도시락 등)으로 3번 이상 식사를 해요.</label>
                                    </li>
                                    <li>	
                                        <label class="label-radio label-question">		
...
<script src="/assets/js/surveyvalidation/surveyQ10.js"></script>
</body>
</html>