                        ...
                        <div class="survey-question-contents">
                            ...
                            <section class="question-section">
                                ...
                                <h2 class="qTitle" maxallowed="1">
                                    <p>${answerMap['surveyQ1'] }님은 몇살이신가요?</p>
                                    <span></span>
                                </h2>
                                <p id="qContent"></p>
                                <ul class="question-answer-wrap">
                                    <li>
                                        <div class="question-input-field">
                                             <input id="answer" name="answer" type="text" class="input-text input-small input-full" placeholder="나이" maxlength="10" required="true">
                                        </div>
                                        <br>
...
<script src="/assets/js/surveyvalidation/surveyQ3.js"></script>
</html>